import { ConditionalReturnType } from '@kpk/gnosis-pay-rewards-sdk';
...
export async function getGnosisPaySafeOwners({
  ...
  | ConditionalReturnType<true, Address[], Error>
  | ConditionalReturnType<false, Address[], Error>
> {
  try {
...
export function getMetirSafeOwners({
  client,
  safeAddress,
  blockNumber,
}: {
